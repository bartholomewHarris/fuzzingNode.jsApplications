...
subprocess.call("./htcap.py crawl -w -t 1800 -x http://localhost:3000/redirect. http://localhost:3000 htcap_juiceshop_report.db \; scan native \; scan arachni \; scan sqlmap \; scan wapiti \; util report htcap_juiceshop_report.html", shell=True)
