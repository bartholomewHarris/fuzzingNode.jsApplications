(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['@angular/core','@angular/platform-browser','@angular/common','exports', '@angular/core', '@angular/common', '@angular/platform-browser'], factory) :
	(factory(global.ng.core,global.ng.platformBrowser,global.ng.common,(global['ng-simple-slideshow'] = {}),global.ng.core,global.ng.common,global.ng.platformBrowser));
...
PointerService.ɵfac = function PointerService_Factory(t) { return new (t || PointerService)(ɵngcc0.ɵɵinject(core.PLATFORM_ID)); };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SlideshowModule, { declarations: [SlideshowComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.BrowserTransferStateModule], exports: [SlideshowComponent] }); })();
