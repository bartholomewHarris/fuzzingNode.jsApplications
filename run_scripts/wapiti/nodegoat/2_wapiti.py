...
#form the command
cmd = "wapiti -u http://localhost:4000 --scope domain -d 10 -a %s --auth-type=post -s http://localhost:4000/login --flush-session  -m all -l 2 -S aggressive --color -v 2 -o ./reports/wapiti" %login
