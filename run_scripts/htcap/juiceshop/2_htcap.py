...
#form the command
cmd = "./htcap.py crawl -w -t %d http://localhost:3000/ htcap_juiceshop_report.db \; scan native \; scan sqlmap \; scan wapiti \; util report htcap_juiceshop_report.html" % SPIDERTIME
