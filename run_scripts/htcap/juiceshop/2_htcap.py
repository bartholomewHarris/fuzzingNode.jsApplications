...
#form the command
cmd = "./htcap.py crawl -t %d -x http://localhost:3000/redirect. http://localhost:3000/ htcap_juiceshop_report.db \; scan native \; scan sqlmap \; scan wapiti \; util report htcap_juiceshop_report.html" % SPIDERTIME
